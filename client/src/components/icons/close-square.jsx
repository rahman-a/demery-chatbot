...
const CloseSquare = ({width, height, className}) => {
    return (
        <svg id="remove" xmlns="http://www.w3.org/2000/svg" width={width} height={height} className={className} viewBox="0 0 18.716 18.716">
